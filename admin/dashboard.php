                        ...
                        <div class="d-flex justify-content-end align-items-center" style="height: 50px; width: 6%; margin-right: 20px">
                            ...
                            <div class="dropdown" style="margin-right: 0px; position: absolute">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark dropdown_menu_setting" aria-labelledby="dropdownMenuButton2">
                                    ...
                                    <!-- Replace the following with your dynamic list of names -->
                                    <li><a style="font-size: 12px; color: white;" class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#infoModal">Name 1</a></li>
                                    <li><a style="font-size: 12px; color: white;" class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#infoModal">Name 2</a></li>
