        ...
        <div class="main-content d-flex">
            <div class="col col-md-2 side_bar">
                <div class="profile_section">
                    <div>
                        <img style="border: 3px solid white; width: 60px; height: 60px; border-radius: 60px; opacity: 1" src="../img/<?= $loggedAdmin['img'] ?>" alt="">
                    ...
                    <div class="row " style="width: 95%; display: flex; justify-content: space-between">
                        <div style="height: 300px; width: 20rem; box-shadow:0px 4px 8px rgba(0,0,0,0.27); margin: 20px 0px; ">
                            <div style="width: 100%; display: flex; justify-content: center; margin: 50px 0 0 0;">
                                <img style="width: 150px; height: 150px;     border-radius: 100px; border: 1px solid rgb(116,0,0)" src="../img/<?php echo $loggedAdmin['img']?>" alt="">
                            </div>
