                                ...
                                <tbody>
                                    <?php foreach ($userList as $user) : ?>
                                        ...
                                        <tr style="height: 40px; background-color: rgb(246, 246, 246); margin-bottom: 10px; border: 1px solid rgba(0, 0, 0, 0.25);">
                                            ...
                                            <td><?= ucfirst($user['fname']) . ' ' . ucfirst($user['initial']) . '. ' . ucfirst($user['lname']); ?></td>
                                            <td><?= $user['course'] ?></td>
                                            <td><?= $user['year'] ?></td>
                        ...
                        <div class="row">
                            ...
                            <form id="AddStudentModal" class="row needs-validation " style="margin-left: 30px; width: 80%; height: 65%; " novalidate>
                                ...
                                <div class="col col-md-4 mt-3">
                                    ...
                                    <div class="input-group has-validation">
                                        <input type="password" class="form-control" placeholder="Password_123" id="addStudentPassword" style="font-size: 10px;" aria-describedby="inputGroupPrepend" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[@_]).{8,}" title="Must contain at least one number, one uppercase and lowercase letter, one symbol, and at least 8 or more characters" required>
                        ...
                        <div class="row">
                            ...
                            <form class="row needs-validation" style="margin-left: 30px; width: 80%; height: 65%; " novalidate>
                                ...
                                <div class="col col-md-4 mt-3">
                                    ...
                                    <div class="input-group has-validation">
                                        <input type="password" class="form-control" placeholder="Password_123" id="editpsw" style="font-size: 10px;" aria-describedby="inputGroupPrepend" readonly>
