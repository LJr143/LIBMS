...
<body style="">
                ...
                <div style="display: flex; justify-content: center; ">
                    <div style="background-color: white; width: 95%; height: 40px; margin: 0px; border-radius: 5px;display: flex;  align-items: center; align-content: center;">
                        <div style="width: 60%; display: flex; justify-content: space-between">
                            ...
                            <button id="newUsersButton" style="background-color: #EFEFEF; font-size: 12px; width: 170px; height: 35px; border-radius: 5px; border: none; box-shadow: 0px 4px 8px rgba(0,0,0,0.27);"><img style="width: 20px;" src="../icons/newuser_report_icon.png" alt=""><span style="margin-left: 10px;">New Users/Visitors</span></button>
                ...
                <div style="display: flex; justify-content: center; margin-top: 10px; ">
                    <div style="background-color: #5A0202; width: 95%; height: 40px; margin: 0px; border-radius: 5px;display: flex;  align-items: center; align-content: center;">
                        <div style="margin: 0px 20px; width: 100%; display: flex;">
                            <div style=" width: 85%;">
                                <a href="report_users_inventory.php"><button style="border: none; background-color: transparent"><img style="width: 20px" src="../icons/back_to.png" alt=""></button></a>
    ...
    <script>
        ...
        const pageUrls = {
            ...
            newUsersButton: 'report_users_visitors_inventory_users_visitors.php',
