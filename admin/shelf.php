...
<body style="">
        ...
        <div class="main-content d-flex">
            ...
            <div class="col" style=" width: 100%; height: 100vh; ">
                <div style="background-color: white; width: 95%; height: 45px; margin: 15px; border-radius: 5px;display: flex; box-shadow: 0px 4px 8px rgba(0,0,0,0.27); align-content: center; align-items: center">
                    <div style="width: 90%">
                        <p style="font-size: 10px; font-weight: 700; margin: 14px">HOME | SHELF</p>
                    </div>
                ...
                <div style="display: flex; justify-content: center; ">
                    <div style="background-color: white; width: 95%; height: 55px; margin: 15px; border-radius: 5px;display: flex; box-shadow: 0px 4px 8px rgba(0,0,0,0.27); align-items: center">
                        <div class="col col-md-2" style="margin-left: 85%;">
                            <button id="addShelfBtn" style="font-size: 12px; width: 150px; height: 30px; border-radius: 5px; background-color: rgb(128,0,0); color: white; border: none">ADD SHELF</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header" style="height: 15px;">
                    ...
                    <p class="modal-title" id="borrowModalLabel " style="font-size: 10px; color: #800000; font-weight: 600;">
                        <i class="bi bi-pencil-square ml-3 m-3" style="font-size: 12px; color: #800000;"></i>ADD SHELF
                    </p>
                ...
                <div class="modal-body">
                    <div class="container-fluid " style="padding-left: 40px ; padding-right: 40px">
                        <div class="row">
                            ...
                            <form id="AddShelfModal" class="row needs-validation " style="margin-left: 30px; width: 80%; height: 65%; " novalidate>
                                <div class="col-md-5 firstname">
                                    <label for="addShelfId" class="form-label mb-0" style="font-size: 12px;">SHELF ID</label>
                                    <input type="text" class="form-control" placeholder="COL0111" id="addShelfId" style="font-size: 10px; text-transform: capitalize !important;" required>
    ...
    <!-- Edit Shelf Modal-->
    <div class="modal fade" id="editShelfModal" tabindex="-1" role="dialog" aria-labelledby="editShelfModalLabel" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered" role="document" style="max-width: 700px;">
            <div class="modal-content">
                <div class="modal-header" style="height: 15px;">

                    <p class="modal-title" id="borrowModalLabel " style="font-size: 10px; color: #800000; font-weight: 600;">
                        <i class="bi bi-pencil-square ml-3 m-3" style="font-size: 12px; color: #800000;"></i>EDIT SHELF
                    </p>
                    <button style="font-size: 16px; background-color: transparent; border:none;" type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
