            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <p class="modal-title" id="borrowModalLabel " style="font-size: 16px; color: #800000; font-weight: 600;">
                        <i class="bi bi-pencil-square ml-3 m-3" style="font-size: 20px; color: #800000;"></i>EDIT PROFILE</p>
                    ...
                    <div class="container-fluid " style="padding-left: 40px ; padding-right: 40px">
                        <div class="row">
                            ...
                            <form class="row  needs-validation"      novalidate>
                                ...
                                <div class="col-md-7 mt-2 " style="margin-left: 90px" >
                                ...
                                <div class="col-md-4 mt-2" style="margin-left: 90px" >
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <input type="number" class="form-control" id="validationCustom01" placeholder="8-7000" style="font-size: 10px;" required>
                                ...
                                <div class="col-md-4 mt-3" >
                                    ...
                                    <input type="number" class="form-control" id="validationCustom01 " min="9" max="9" placeholder="202100565" style="font-size: 10px;"
                                           required>
